    ...
    <div>
        ...
        <div className='bg-pure-greys-5 text-richblack-700'>
          ...
          <div className='homepage_bg h-[320px]'>
            ...
            <div className='w-11/12 max-w-maxContent mx-auto flex flex-col items-center gap-8 justify-center '>
          ...
          <div className='w-11/12 max-w-maxContent mx-auto flex flex-col items-center justify-between gap-7'>
            ...
            <div className='flex flex-col lg:flex-row gap-7 lg:gap-0  mb-10 -mt-[100px] lg:mt-20 justify-between'>
