                ...
                <div className="max-w-[500px] p-4 lg:p-8">
                    ...
                    <form onSubmit={handleOnSubmit} >
                        ...
                        <label className='relative'>
                            ...
                            <input required type={showPassword?'text':'password'} name='password' value={FormData.password} onChange={handleOnChange}
                                    placeholder='Enter password'  className="form-style w-full !pr-10" />
                        ...
                        <label className="relative mt-3 block">
                            ...
                            <input required   type={showConfirmPassword ? "text" : "password"}  name="confirmPassword"   value={formData.confirmPassword}  onChange={handleOnChange} 
                                          placeholder="Confirm Password"  className="form-style w-full !pr-10"/>
